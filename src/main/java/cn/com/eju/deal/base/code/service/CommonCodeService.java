...
public class CommonCodeService extends BaseService<Object> 
{
     ...
     * @return
     */
    public ResultData<?> queryByDicCode(String dicCode) throws Exception
    {
        
        //构建返回
        ResultData<CommonCodeDto> resultData = new ResultData<CommonCodeDto>();
        
        //查询
        final Code code = commonCodeMapper.queryByDicCode(dicCode);
        
        //转换
        CommonCodeDto codeDto = new CommonCodeDto();
        BeanUtils.copyProperties(code, codeDto);
        
        resultData.setReturnData(codeDto);
