...
/**
 * @Auther: xuliangliang
 * @Date: 2018\10\24 0024 09:31
 * @Description:
 */
public interface StorePreserveMapper {
     ...
     * @return
     */
    List<ExpandDetail> searchStorePreserve(Map<String, Object> reqMap) throws Exception;
    ...
    List<StorePreserveSummary> searchStorePreserveSummary(Map<String, Object> reqMap) throws Exception;
    List<StorePreserveSummary> searchStorePreserveSummaryByPersonal(Map<String, Object> reqMap) throws Exception;
    List<StorePreserveSummary> exportStorePreserveSummary(Map<String, Object> reqMap) throws Exception;
}
