...
public class ExpendReportController {
	...
	@Resource(name = "expandDetailService")
	private ExpandDetailServiceImpl expandDetailService;
	...
	*/
	...
	public String getUserCenterAuthCityName(
		...
		List<UserCenterAuthDto> list=expandDetailService.getUserCenterAuthCityName(queryParam);
	...
	public String getAreaGroupName(@PathVariable String param) {
		...
		List<UserCenterAuthDto> list = expandDetailService.getAreaGroupName(queryParam);
	...
	public String getCenterGroupName(@PathVariable String param) {
		...
		if ("1".equals(typeId)) {
			...
			queryParam.put("list", idlist);
			// 获取页面显示数据
			list = expandDetailService.getCenterGroupName(queryParam);
			...
			queryParam.put("list", idlist);
			// 获取页面显示数据
			list = expandDetailService.getGroupName(queryParam);
		}
	 ...
	 * @return
	 */
	@RequestMapping(value = "queryExpandDetailList/{param}", method = RequestMethod.GET)
...
//		Map<String, Object> paramdata = new HashMap<String, Object>();
		...
		List<ExpandDetail> list= expandDetailService.queryExpandDetailList(queryParam);
		if(list != null)
		{
			int size = list.size();
	 ...
	 * @return
	 */
	@RequestMapping(value = "exportExpandDetailList/{param}", method = RequestMethod.GET)
	public String exportExpandDetailList(@PathVariable String param) {
...
//		paramdata = ChangeParam(queryParam);
	 ...
	 */
   	private void handlerParam(Map<String, Object> queryParam){
		//处理参数
		for (Entry<String, Object> e : queryParam.entrySet()) { 
			String key = e.getKey();
