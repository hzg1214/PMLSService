...
//		}
		...
		if(!CollectionUtils.isEmpty(jyComList)) {
			...
			String companyName = borrowMoneyFrameContractDto.getCompanyName();
...
//				BorrowMoneyCompanyRelated borrowMoneyCompanyRelated = getBorrowMoneyCompanyRelated(borrowMoneyCompanyDto,companyNo,companyName,userIdUpt);
//				int count = borrowMoneyFrameContractMapper.updateBorrowMoneyCompany(borrowMoneyCompany);
//				int count1 = borrowMoneyFrameContractMapper.updateBorrowMoneyRelated(borrowMoneyCompanyRelated);
//			}
			//删除之前借佣关联的公司
    ...
    private BorrowMoneyCompanyRelated getBorrowMoneyCompanyRelated(BorrowMoneyCompanyDto borrowMoneyCompanyDto,
			String companyNo,String companyName, Integer userIdUpt) {
		...
		borrowMoneyCompany.setParentCompanyName(companyName);
		...
		borrowMoneyCompany.setUserIdUpdate(userIdUpt+"");
...
//        String templateName = param.get("templateName");
        ...
        borrowMoneyFrameContract.setOaNo(oaNo);
//        borrowMoneyFrameContract.setTemplateCode(templateCode);
//        borrowMoneyFrameContract.setTemplateName(templateName);
     ...
     * 2020年5月8日
     */
    public ResultData<?> remove(Map<String,Object> param) {
		ResultData resultData = new ResultData();
		int count  = borrowMoneyFrameContractMapper.removeBorrowMoneyCompany(param);
		int count1 = borrowMoneyFrameContractMapper.removeBorrowMoneyCompanyRelated(param);
