...
public class SceneCommissionDetailSearchResultDto  implements Serializable {
	...
	private String reportDate10;
	// 认定日期
	private Date recognitionDay;
	private String recognitionDay10;
	// 结算状态
	...
	public String getRecognitionDay10() {
		return new SimpleDateFormat("yyyy-MM-dd").format(recognitionDay);
	}
	public void setRecognitionDay10(String recognitionDay10) {
		this.recognitionDay10 = recognitionDay10;
	}
