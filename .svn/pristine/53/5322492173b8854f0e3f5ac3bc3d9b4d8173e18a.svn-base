...
public class BorrowMoneyFrameContractDto extends BorrowMoneyFrameContract  implements Serializable{
	...
	private List<BorrowMoneyCompanyDto> jyComList;
	...
	public List<BorrowMoneyCompanyDto> getJyComList() {
		return jyComList;
	}

	public void setJyComList(List<BorrowMoneyCompanyDto> jyComList) {
