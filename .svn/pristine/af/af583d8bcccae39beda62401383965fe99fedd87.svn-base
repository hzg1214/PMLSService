...
public class EstateDto implements Serializable {
    ...
    //报备数
    private String relationUnconfirm;

    //带看数
    private String pledgedUnconfirm;

    //大定数
    private String signUnconfirm;

    //成销数
    private String signConfirm;

    private String brokerageConfirm;
    ...
    private DeveloperDto developerDto;//开发商origin info
	...
	public void setBbCount(String bbCount) {
		this.bbCount = bbCount;
	}

	public String getCxCount() {
		return cxCount;
	}

	public void setCxCount(String cxCount) {
	...
	public void setJyCount(String jyCount) {
     ...
     */
    public String getTypeKbnStr() { return getStrByCode(typeKbn);    }
    ...
    public String getRelationUnconfirm() {
        return relationUnconfirm;
    }

    public void setRelationUnconfirm(String relationUnconfirm) {
        this.relationUnconfirm = relationUnconfirm;
    }

    public String getPledgedUnconfirm() {
        return pledgedUnconfirm;
    }

    public void setPledgedUnconfirm(String pledgedUnconfirm) {
        this.pledgedUnconfirm = pledgedUnconfirm;
    }

    public String getSignUnconfirm() {
        return signUnconfirm;
    }

    public void setSignUnconfirm(String signUnconfirm) {
        this.signUnconfirm = signUnconfirm;
    }
    ...
    public String getBrokerageConfirm() {
        return brokerageConfirm;
    }

    public void setBrokerageConfirm(String brokerageConfirm) {
	...
	public String getParticularFlagStr() {
		return SystemParam.getDicValueByDicCode(particularFlag + "");
	}
	...
	public String getDirectSignFlagStr() {
		return SystemParam.getDicValueByDicCode(directSignFlag + "");
	}
	...
	public String getBigCustomerFlagStr() {
		return SystemParam.getDicValueByDicCode(bigCustomerFlag + "");
	}
    ...
    private Date dyStartDate;
    private Date dyEndDate;
    private BigDecimal dyAmount;

    public Date getDyStartDate() {
        return dyStartDate;
    }

    public void setDyStartDate(Date dyStartDate) {
        this.dyStartDate = dyStartDate;
    }

    public Date getDyEndDate() {
        return dyEndDate;
    }

    public void setDyEndDate(Date dyEndDate) {
        this.dyEndDate = dyEndDate;
    }
    ...
    public String getBrushRaiseFlagStr() {
        return SystemParam.getDicValueByDicCode(brushRaiseFlag + "");
    }
    ...
    public String getTotalFieldFlagStr() {
        return SystemParam.getDicValueByDicCode(totalFieldFlag + "");
    }
    ...
    public String getIsExcuseCommisionStr() {
        return SystemParam.getDicValueByDicCode(isExcuseCommision + "");
    }

    public void setIsExcuseCommisionStr(String isExcuseCommisionStr) {
        this.isExcuseCommisionStr = isExcuseCommisionStr;
    }
