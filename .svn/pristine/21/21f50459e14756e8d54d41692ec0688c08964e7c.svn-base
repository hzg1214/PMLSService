 ...
 */
public class ExchangeAchievementDtoOld
{
     ...
     * 门店维护人经理工号
     */
    private String maintainerLeaderId;

    /**
     * 门店维护人经理姓名
     */
    private String maintainerLeader;
     ...
     * 门店维护人专员所属组Id
     */
    private Integer maintainerGroupId;
    
    /**
     * 门店维护人专员所属岗位Id
     */
    private Integer maintainerPostId;
    
    /**
     * 门店维护人经理所属组Id
     */
    private Integer maintainerLeaderGroupId;
    
    /**
     * 门店维护人经理所属岗位Id
     */
    private Integer maintainerLeaderPostId;
    ...
    public String getMaintainerLeaderId()
    {
        return maintainerLeaderId;
    }

    public void setMaintainerLeaderId(String maintainerLeaderId)
    {
        this.maintainerLeaderId = maintainerLeaderId;
    }

    public String getMaintainerLeader()
    {
        return maintainerLeader;
    }

    public void setMaintainerLeader(String maintainerLeader)
    {
        this.maintainerLeader = maintainerLeader;
    }
    ...
    public Integer getMaintainerGroupId()
    {
        return maintainerGroupId;
    }

    public void setMaintainerGroupId(Integer maintainerGroupId)
    {
        this.maintainerGroupId = maintainerGroupId;
    }

    public Integer getMaintainerPostId()
    {
        return maintainerPostId;
    }

    public void setMaintainerPostId(Integer maintainerPostId)
    {
        this.maintainerPostId = maintainerPostId;
    }

    public Integer getMaintainerLeaderGroupId()
    {
        return maintainerLeaderGroupId;
    }

    public void setMaintainerLeaderGroupId(Integer maintainerLeaderGroupId)
    {
        this.maintainerLeaderGroupId = maintainerLeaderGroupId;
    }

    public Integer getMaintainerLeaderPostId()
    {
        return maintainerLeaderPostId;
    }

    public void setMaintainerLeaderPostId(Integer maintainerLeaderPostId)
    {
        this.maintainerLeaderPostId = maintainerLeaderPostId;
    }
