...
public class FollowDto extends Follow implements Serializable
{
    ...
    */
    ...
    //跟进详情 签到图片
    private List<FileRecordMainDto> signTimeFiles = new ArrayList<>();
    
    //跟进详情 签退图片
    private List<FileRecordMainDto> signOutTimeFiles = new ArrayList<>();
    
    public List<FileRecordMainDto> getSignTimeFiles() {
		return signTimeFiles;
	}

	public void setSignTimeFiles(List<FileRecordMainDto> signTimeFiles) {
		this.signTimeFiles = signTimeFiles;
	}

	public List<FileRecordMainDto> getSignOutTimeFiles() {
		return signOutTimeFiles;
	}

	public void setSignOutTimeFiles(List<FileRecordMainDto> signOutTimeFiles) {
		this.signOutTimeFiles = signOutTimeFiles;
	}
